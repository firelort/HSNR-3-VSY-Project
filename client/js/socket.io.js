...
!function(t, e) {
    ...
    return function(t) {
        ...
        function r(t, e) {
            ...
            t = void 0),
            e = e || {};
            var n, r = i(t), s = r.source, p = r.id, h = r.path, f = u[p] && h in u[p].nsps, l = e.forceNew || e["force new connection"] || !1 === e.multiplex || f;
            return l ? (c("ignoring socket cache for %s", s),
            n = a(s, e)) : (u[p] || (c("new io instance for %s", s),
            u[p] = a(s, e)),
            n = u[p]),
    ...
    , function(t, e, n) {
        (function(e) {
            function r(t, n) {
                ...
                n.port = t.port,
                t.query && (n.query = t.query)) : n.host && (n.hostname = p(n.host).host),
        ...
        (function(t, o) {
            !function(i) {
                ...
                function p(t, e) {
                    ...
                    n = w(t >> 12 & 15 | 224),
                    n += u(t, 6)) : 0 == (4292870144 & t) && (n = w(t >> 18 & 7 | 240),
                    n += u(t, 12),
                    n += u(t, 6)),
                    n += w(63 & t | 128)
                }
    ...
    , function(t, e, n) {
        (function(e) {
            ...
            var o, i = n(20), s = n(21), a = n(30), c = n(31), u = n(32), p = n(3)("engine.io-client:websocket"), h = e.WebSocket || e.MozWebSocket;
    ...
    , function(t, e, n) {
        ...
        ,
        r.prototype.onopen = function() {
            if (p("transport is open - connecting"),
            "/" !== this.nsp)
                if (this.query) {
